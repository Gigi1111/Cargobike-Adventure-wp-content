document.addEventListener("DOMContentLoaded", function(event) {
    ...
    jQuery('#pwgc-create-gift-card-form').on('submit', function(e) {
        ...
        jQuery.post(ajaxurl, {'action': 'pw-gift-cards-create_gift_card', 'amount': amount, 'quantity': quantity, 'expiration_date': expirationDate, 'note': note, 'from': fromString, 'recipient': recipient, 'design_id': designId, 'security': pwgc.nonces.create_gift_card}, function(result) {
